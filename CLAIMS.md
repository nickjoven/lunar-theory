...
| 7 | Volatiles exit bound regime | Three-channel product: sid × therm × cond | K: 15×, S: 38×, Na: 42× | χ²/N = 1.28 (13 elem) | A low-boiling-point element NOT depleted in Moon |
...
| 12 | Inclination from Cassini bifurcation | Laplace plane transition at ~15 R_E gives 4.88° | i = 5.145° | 5.2% | Inclination requires formation geometry, not tidal dynamics |
...
(v_thr = 8.8% of v_esc, consistent with Jeans λ_crit ≈ 10), and
condensation retention (T_cond from Lodders 2003). The product fits
all 13 elements at χ²/N = 1.28 with 2 free parameters. Zn and Rb
remain outliers (>10× underprediction), attributable to sulfide
partitioning.

The Cassini inclination (claim 12) is derived from the Laplace plane
transition at ~15 R_E: i_0 = ε/2 = 7.65°, damped to 4.88° over
4.5 Gyr. Residual: 5.2% against the observed 5.145°.
